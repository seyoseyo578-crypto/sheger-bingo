...
<!-- Slim top bar (replaces the old big welcome banner) -->
<div class="topbar">
...
<div id="tab-game" class="tabContent">
    ...
    🕒 ቀጣይ ጨዋታ በ <span id="countdown">60</span> ሰከንድ ውስጥ በራስ-ሰር ይጀምራል
    </div>
    ...
    <button id="openCardsBtn" onclick="openCards()">
    + ካርቴላ ይጨምሩ
    </button>
...
<div id="tab-leaderboard" class="tabContent hidden">
    ...
    <div class="panel">
    <h2>🏆 Leaderboard</h2>
    <p>ብዙ-ተጫዋች የደረጃ ሰንጠረዥ ገና በዝግጅት ላይ ነው — ይሄ እውነተኛ ተጫዋቾችን ማወዳደር server ስለሚፈልግ በቅርቡ ይመጣል።</p>
    </div>
...
<!-- ========== TAB: 💰 ዋሌት (Wallet: Deposit + Withdraw) ========== -->
<div id="tab-wallet" class="tabContent hidden">
    ...
    <div class="panel">
        ...
        type="number"
        id="depositAmount"
        placeholder="የሚያስገቡት ብር">

        <input
        type="text"
        id="depositProof"
        placeholder="የክፍያ ማረጋገጫ">
    ...
    <div class="panel">
        ...
        type="number"
        id="withdrawAmount"
        placeholder="የሚወጣው ብር">

        <input
        type="text"
        id="withdrawAccount"
        placeholder="Telebirr / CBE ቁጥር">
...
<!-- Full-screen card picker: opened by "+ ካርቴላ ይጨምሩ" -->
<div id="cardList" class="cardPickerOverlay hidden">
    ...
    <div id="cardPickerSelectedList" class="cardPickerSelectedList"></div>
